      ...
      $count=$row[0];
            ...
            <div class="card-body">
              <div style="overflow:auto">
                    <!-- <a href="pause-play-msg.php?status=ready" style=""class="btn btn-success">Start Messages</a>&nbsp; -->
              <!-- <a href="pause-play-msg.php?status=pause"  style=""class="btn btn-danger">Stop Messages</a><br></br> -->
              <table class="table table-striped table-bordered datatable table-responsive-sm" id="dataTable">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th>Service Type</th>                    <th>User Number</th>
                    <th>Message</th>
                    <!--th>Media</th-->
                    <th>Plivo Number</th>
                     <th>Added on</th>
        ...
        ?>
                  <tr id="tr" class="tr<?php echo $row['id'];?>">
                      <td><?php echo $i; ?></td>
                          <td><?php echo $row['service_type']; ?></td>                          <td><?php echo $row['sms_number']; ?></td>
