...
<span class="help-block"> You can send an image also.</span>
                   ...
                   <div class="form-group emoji-contant-align">
                    ...
                    <div class="form-group emoji-contant-align" id="custome_messgae">
                      ...
                      <div class="controls">
                        <div class="input-prepend input-group">
                         <textarea id="examplename" name="mymessage" data-control="exname-control" rows="9" class="form-control" placeholder="Write your Message Here!" data-emojiable="true" ></textarea>
                        </div>
                      </div>
                    </div>
