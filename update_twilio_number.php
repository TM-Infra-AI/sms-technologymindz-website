...
$sql=mysqli_query($con,"update tapp_twilio_number set service_type = '".$service_type."',client_name='".$client_name."',number='".$num."',twilio_sid='".$_POST['sid']."',twilio_token='".$token."',is_default='".$is_default."',endpoint_user='".$endpoint_user."',endpoint_pass='".$endpoint_pass."',date_time=now() where id='".$id."'");
