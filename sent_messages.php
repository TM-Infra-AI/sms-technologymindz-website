...
<th>Delete</th>
        ...
        $query = mysqli_query($con,"select * from tapp_sent_msg_log where sms_number='".$msg_num."' or message  like '%".$msg_num."%'  group by bulk_name,sms_number order by date_time desc ") ;
...
<th>Delete</th>
        ...
        <?php 
    $query = mysqli_query($con,"select * from tapp_sent_msg_log group by bulk_name,sms_number order by date_time desc") ;
