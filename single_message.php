              ...
              <div class="card">
                ...
                <div class="card-body col-lg-7">
                  <form class="form-horizontal" id="formValidate2" data-validate="parsley" method="post" action="get_single_msg.php" name="client_record" enctype="multipart/form-data" onsubmit="return check_lenght()">
                    ...
                    <div class="form-group" id="number_holder">
                      ...
                      <div class="controls">
                        <div class="input-prepend input-group">
                          ...
                          <input id="prependedInput" class="form-control" name="number" size="16" type="text" placeholder="Write Number Here!" list="listid" required>
					...
					<option value="twilio">Plivo</option>   
    ...
    ?>
	    ...
	    <div class="form-group emoji-contant-align">
                    ...
                    <div class="form-group emoji-contant-align" id="custome_messgae">
                      ...
                      <div class="controls">
                        <div class="input-prepend input-group">
                         <textarea id="messagebox" name="message" data-control="exname-control" rows="9" class="form-control" placeholder="Write your Message Here!"  onkeyup="get_counts(this.value)" maxlength="160"></textarea></textarea><br>
					...
					<div class="form-group emoji-contant-align" id="">
					 ...
					 <div class="form-group emoji-contant-align" id="showtemplate">
                      ...
                      <div class="controls">
                        <div class="input-prepend input-group">
                         <textarea id="messagebox1" name="message1" maxlength="160" rows="9" class="form-control" placeholder="Write your Message Here!"  onkeyup="get_counts(this.value)"></textarea>
						 <br>
