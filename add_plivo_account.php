                ...
                <tbody>
                  ...
                  <tr id="tr" class="tr<?php echo $row['id'];?>">
                   <td><?php echo $i; ?></td>
                    ...
                    <td><?php echo $row['sms_per_minute']; ?></td>
                     <!-- ss -->
                   <td>
    ...
    <div class="modal-dialog">
      ...
      <input type="hidden" value="<?php echo $row['id'];?>" name="id">
        ...
        <div class="modal-header">
          <h4 class="modal-title text-center">Update Plivo Details</h4>
		...
		<div class="col-sm-12">
                      ...
                      <div class="form-group">
						...
						<option value="plivo" <?php if($row['service_type'] == 'plivo') echo "selected";?>>Plivo</option>
						</select>
                      </div>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <label for="accntoken">SMS/Minute </label>
                        <br>
                          <input type="text" id="" value="<?php echo $row['sms_per_minute'];?>" placeholder="Enter SMS Per Minute" onKeyUp="checkkeyword(this.value)" required class="form-control input-sm parsley-validated "  name="sms_per_minute" value="30">
                         </div>
...
<div class="modal fade" id="delete<?php echo $row['id']; ?>">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title text-center">Delete Plivo Details</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <div class="modal-body">
         <div class="row">
                    ...
                    <label>Are you sure you want to delete your plivo account? This action can't be undone.</label>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header"> 
          <h4 class="modal-title text-center">Add Plivo Details</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
