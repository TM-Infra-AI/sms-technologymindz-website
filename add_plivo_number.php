...
?>    <!-- Main content -->
 ...
 <select name="sid" class="form-control" onchange="enableendpoint<?php echo $row['id'];?>(this.value)">		
 ...
 <?php } ?>					
          ...
          <script>
          function enableendpoint<?php echo $row['id'];?>(elem)
          {
              
              if(elem == 'plivo')
              {
              document.getElementById("enableend<?php echo $row['id'];?>").style.display='block';
              }
              else
              {
                  document.getElementById("enableend<?php echo $row['id'];?>").style.display='none';
              }
          }
          </script>
     ...
     <!--        <div id="enableend<?php echo $row['id'];?>" style="display:none">
             <div class="form-group">

             <label class="control-label">Endpoint User (Only for plivo)</label>

            <input type="text" id="twilio_num" placeholder="Enter Endpoint username" value="<?php echo $row['endpoint_user']; ?>"  required class="form-control input-sm parsley-validated "  name="endpoint_user">
             ...
             <label class="control-label">Endpoint Password (Only for plivo)</label>

            <input type="text" id="" placeholder="Enter Endpoint password" value="<?php echo $row['endpoint_pass']; ?>"  required class="form-control input-sm parsley-validated "  name="endpoint_pass">
...
<!-- 				    <div id="" >
            ...
            <input type="text" id="endpoint_user" placeholder="Enter Endpoint username" value="" onBlur="" required class="form-control input-sm parsley-validated "  name="endpoint_user">
            ...
            <input type="text" id="" placeholder="Enter Endpoint password" value="" onBlur="" required class="form-control input-sm parsley-validated "  name="endpoint_pass">
